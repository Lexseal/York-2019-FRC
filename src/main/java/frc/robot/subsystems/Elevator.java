...
public class Elevator extends Thread {
	...
	public double[] getCurAng() {
		double accX = acc.getAccelInstantX();
		double accY = acc.getAccelInstantY();
		double accZ = acc.getAccelInstantZ();
	...
	public void run() {
		...
		while (true) {
			...
			if (levelingMode) {
				...
				double dError = acc.getGyroInstantY();
